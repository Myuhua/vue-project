//vue-cli中webpack.prod.conf.js是webpack生产环境的核心配置文件
'use strict'
// 引入nodejs的路径模块
...
// webpack.base.conf.js配置文件用来处理不同类型文件的loader
...
const webpackConfig = merge(baseWebpackConfig, {
  ...
  plugins: [
    ...
    // 下面是复制文件的插件，可能在这里并不是起到复制文件的作用，而是过滤掉打包过程中产生的以.开头的文件
...
if (config.build.productionGzip) {
  ...
  // vue-cli默认将这个功能禁用掉的，理由是Surge 和 Netlify 静态主机默认把上传的文件gzip了
